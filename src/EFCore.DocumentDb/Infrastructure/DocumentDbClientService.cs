...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    public class DocumentDbClientService : IDocumentDbClientService
    {
        ...
        {
            var option = dbContextOptions.Extensions.OfType<DocumentDbOptionsExtension>().Single();

            _databaseId = option.DatabaseName;
            _documentClient = new DocumentClient(option.ServiceEndPoint, option.AuthKeyOrResourceToken);
            _logger = logger;
